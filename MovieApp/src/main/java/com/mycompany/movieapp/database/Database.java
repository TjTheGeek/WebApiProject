...
=======
            //Here are are adding Customers to tthe Database and Accoutns to the customers and the movie to the account
/*First Movie*/  Movie movie1 = new Movie(movieTB.size()+1,"Red Wedding", "Watch", "Ting's Documentary");
                 movieTB.add(movie1);
                 Movie movie4 = new Movie(movieTB.size()+1,"Yellow Wedding", "Watch", "Marcis's Documentary");
                 movieTB.add(movie4);
/*Second Movie*/ Movie movie2 = new Movie(movieTB.size()+1,"Blue Wedding", "Recommended", "TJ's Documentary");
                 movieTB2.add(movie2);
                 Movie movie3 = new Movie(movieTB2.size()+1,"green Wedding", "Recommended", "Jegans's Documentary");
                 movieTB2.add(movie3);
/*First Accounts for customer*/
...
/*Second Accounts for customer*/
                 ...
                 accountsTB2.add(account4);            
/*FirstCustomer*/Customer customer1 = new Customer("Abraham", "Dublin 2", "Marcus@gmail.com", customerTB.size()+1,accountsTB);
                 customerTB.add(customer1);
                 /*Second Customer*/
